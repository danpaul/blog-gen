...
import FilterSourceStaticFiles from "../lib/plugins/FilterSourceStaticFiles/FilterSourceStaticFiles";
...
(async () => {
  ...
  blogGen.addSourceFilter(
    FilterSourceStaticFiles({ contentRoot: CONTENT_ROOT })
  );
  blogGen.run();
